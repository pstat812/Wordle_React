/**
 * Absurdle Game Page Component
 * 
 * This component handles the Absurdle game mode, including game logic,
...
function AbsurdlePage({ 
  ...
  // Game hooks
  const game = useWordleGame('absurdle');
          ...
          <div className="game-over-modal">
            <div className="game-over-modal__content">
              ...
              <p className="game-over-modal__message">
                {game.won 
                  ? `You found the word "${game.answer}" in ${game.guesses.length} attempt${game.guesses.length === 1 ? '' : 's'}!`
                  : `The word was "${game.answer}". Try again!`
                }
              </p>
